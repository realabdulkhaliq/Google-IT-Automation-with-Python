...
# character-only top-level domain such as ".com", ".info", ".edu", etc. Fill in the 
# regular expression to do that, using escape characters, wildcards, repetition qualifiers, 
