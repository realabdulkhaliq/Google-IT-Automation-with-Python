...
# This function should use a list comprehension to create a list of numbers 
# incremented by 2 (n+2). The function receives two variables and should return 
# a list of incremented consecutive numbers between “start” and “end” inclusively 
