...
# This function should split up the words in the given “string” and return the number of words
#  in the “string”.  Complete the string operation and method needed in this function 
